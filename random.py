...
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Admin                   • \33[1;38mSAWON ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • SAWON ISLAM ]   ║  \033[1;97m  
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
╠══[VERSION                  • 0.0 ]          ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m"""""")
def linex():
	print('\033[1;93m ⊰᯽⊱┈──╌❊❊╌──┈⊰᯽⊱❊╌──┈⊰᯽⊱⊰᯽⊱┈──╌❊')
loop = 0
...
def xxr():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f' \033[1;91m[\033[1;97m🌺\033[1;91m]\033[1;94m TOOL OWNER \033[1;97m: \033[1;96m ᥬME>SAWON🐿️🐝❤️‍🔥🍇🎁')
...
def superuser():
    ...
    id = "71".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/RAK1B-KING/Xx/blob/main/Xx.txt").text
    if id in DARK:
        os.system('clear')
        print(logo)
        xxr()
        ...
        os.system('am start https://wa.me/+8801939204076?text=' + tks)
        superuser()        
superuser()
